...
class CartControllerIntegrationTest {
    ...
    void updateItemQuantity_success_integration() throws Exception {
        ...
        // 実行 (Act): 数量を5に変更
        com.example.samplebootapp.presentation.order.request.CartItemUpdateRequest updateRequest = new com.example.samplebootapp.presentation.order.request.CartItemUpdateRequest(
                5);
